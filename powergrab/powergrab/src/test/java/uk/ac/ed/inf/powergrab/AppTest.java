...
public class AppTest extends TestCase {
	...
	public void testMove() {
		System.out.println(p0.latitude + " " + p0.longitude);
		System.out.println(p0.nextPosition(Direction.N).latitude + " " + p0.nextPosition(Direction.N).longitude);
		System.out.println(p0.nextPosition(Direction.S).latitude + " " + p0.nextPosition(Direction.S).longitude);
	}
